    ...
    page(id: "/${slug}", idType: URI) {
      flexibleContent {
        blocks {
          ...
          ... on Page_Flexiblecontent_Blocks_Tiles {
            fieldGroupName
            title
            description
            buttons {
          ...
          ... on Page_Flexiblecontent_Blocks_VideoBackgroundHero {
            backgroundUrl
            description
            fieldGroupName
            title
          ...
          ... on Page_Flexiblecontent_Blocks_PromoImageAndText {
            fieldGroupName
            title
            description
            image {
          ...
          ... on Page_Flexiblecontent_Blocks_InformationCards {
            fieldGroupName
            cards {
              size
              icon {
          ...
          ... on Page_Flexiblecontent_Blocks_LinksInGroups {
            fieldGroupName
            title
            description
            groups {
