...
export const ProductWithBlocksFragment = /* GraphQL */ `
  fragment ProductWithBlocksFragment on Product {
    ...
    flexibleContent {
      blocks {
        # testing-only strip: FlexibleContentBlocksCarouselFlexibleContentBlockLayout
        # is not in testing WP's schema; including it makes WPGraphQL reject
        # the entire query with "Unknown type ...". Revert before merging
        # this file to main/staging.
        ...
        # testing-only strip: FlexibleContentBlocksButtonLinkTagLayout missing
        # from testing WP schema (see Carousel strip above).
