...
import ButtonLinkTagBlock from './blocks/button-link-tag';
import CarouselFlexibleContentBlockBlock from './blocks/carousel-flexible-content-block';
...
import ClickableLogosBlock from './blocks/clickable-logos';
...
import ProductMakeGridBlock from './blocks/product-make-grid';
...
async function render(
  ...
  switch (blockName) {
    ...
    case 'ButtonLinkTag':
      return ButtonLinkTagBlock(block);

    case 'CarouselFlexibleContentBlock':
      return CarouselFlexibleContentBlockBlock(block);

    case 'CategoriesAndProducts':
      return CategoriesAndProductsBlock(block);

    case 'ClickableLogos':
      return ClickableLogosBlock(block);
    ...
    case 'ProductMakeGrid':
      return ProductMakeGridBlock(block, { isCategoryPage });
...
export async function renderBlock(
  ...
  return (
    <DownloadLinkWrapper blockName={blockName} tagId={block?.tagId}>
      {background ? (
